...
var engine = props.globals.getNode("sim/model/dauphin/engine");
...
var turbine = props.globals.getNode("sim/model/dauphin/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/dauphin/torque-pct", 1);
